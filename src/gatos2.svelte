<script>
  ...
  import { arrayfiltrado2 } from "./store.js";
          ...
          <div class="gato-wrapper">
            ...
            "
              ...
              <div class="manchas">
                <Mancha
                  tipo={pelicula.Tipo}
                  cant={manchaVentas2(pelicula.Ventas)}
                  tamano={diamRating2(pelicula.Rating) * 0.634}
                  altura={diamRating2(pelicula.Rating)}
                />
              </div>
              <div class="person-color">
                <Color
                  ...
                  tamano={diamRating2(pelicula.Rating) * 0.634}
                  altura={diamRating2(pelicula.Rating)}
                  color={colorDuracion2(pelicula.Duracion)}
                />
              </div>
            </div>
